...
///
/// @brief Raspberry Pi 3+
/// @note Numbers refer to BCM from WiringPi, not pins
/// @see https://github.com/earlephilhower/arduino-pico
/// @note Recommended board
///
const pins_t boardRaspberryPi3B =
{   ///< EXT3 and EXT3-1 pin 1 Black -> +3.3V
    ///< EXT3 and EXT3-1 pin 2 Brown -> SPI SCK GP18
    .panelBusy = 21, ///< EXT3 and EXT3-1 pin 3 Red -> GP13
    .panelDC = 22, ///< EXT3 and EXT3-1 pin 4 Orange -> GP12
    .panelReset = 23, ///< EXT3 and EXT3-1 pin 5 Yellow -> GP11
    ///< EXT3 and EXT3-1 pin 6 Green -> SPI MISO GP16
    ///< EXT3 and EXT3-1 pin 7 Blue -> SPI MOSI GP19
    .flashCS = 42, ///< EXT3 and EXT3-1 pin 8 Violet -> GP10
    .panelCS = 25, ///< EXT3 and EXT3-1 pin 9 Grey -> GP17
